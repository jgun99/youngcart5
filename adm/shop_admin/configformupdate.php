...
$sql = " update {$g5['g5_shop_default_table']}
            set de_admin_company_owner        = '{$_POST['de_admin_company_owner']}',
				...
				de_paypal_api_username		          = '{$_POST['de_paypal_api_username']}',
				de_paypal_api_password		          = '{$_POST['de_paypal_api_password']}',
				de_paypal_exchange_rate		          = '{$_POST['de_paypal_exchange_rate']}',
